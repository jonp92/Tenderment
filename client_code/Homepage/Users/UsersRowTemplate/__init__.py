...
class UsersRowTemplate(UsersRowTemplateTemplate):
  ...
  def button_save_click(self, **event_args):
    ...
    anvil.server.call('save_user', self.item.get_id(), self.text_box_first_name.text, self.text_box_last_name.text, self.text_box_email.text, self.text_box_role.text, self.check_box_enabled_edit.checked, self.check_box_confirmed_email_edit.checked, self.text_box_password_hash.text)
